...
### 3. **Inicio de sesión con Google (implementado en Sprint 2):**
- Para iniciar sesión en nuestra aplicación con su cuenta de Google, deberá pulsar el botón rojo "" de la pantalla de inicio.
- A continuación deberá elegir la cuenta de Google con la que quiere entrar en el sistema.
- Si no tiene una cuenta asociada a dicho correo, se le pedirá información adicional para completar su perfil. Cuando haya terminado de añadir la información, pulse sobre el botón azul "Guardar". Al ser su primera vez en la aplicación, deberá contestar un rápido cuestionario para conocer sus preferencias. [Punto 4](#4-seleccion-de-preferencias)
- Finalmente, será enviado a nuestra página principal.


### 4. **Selección de preferencias (ligeras modificaciones respecto al Sprint 1):**
...
### 5. **Gestión del perfil (implementado en Sprint 2):**
...
- Si pulsa sobre el botón rojo "Eliminar cuenta", será redirigido a la pantalla de inicio, se le cerrará la sesión y se borrará su cuenta de nuestro sistema.


### 6. **He olvidado mi contraseña (implementado en Sprint 2):**
...
| Contraseña usuario 1 | ispp-1234 |
| Usuario 2 | hello |
